      ...
      <div className="footer-shell">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr_0.8fr_0.9fr]">
          <div className="space-y-5">
            <div>
              <p className="text-xs uppercase tracking-[0.28em] text-[rgba(255,247,239,0.58)]">
                Book World
              </p>
              <h3 className="mt-3 text-4xl text-[#fff7ef]">
                Reading, listening, and discovery in one calm place.
              </h3>
            </div>
            <p className="max-w-md text-base leading-7 text-[rgba(255,247,239,0.72)]">
              Explore stories, revisit your library, and turn books into richer
              experiences with summaries, analytics, and audio features built
              for modern readers.
            </p>
            <div className="grid max-w-lg gap-3 sm:grid-cols-3">
              <div className="rounded-[1.4rem] border border-white/10 bg-white/5 px-4 py-4">
                <p className="text-2xl font-semibold text-[#fff7ef]">24/7</p>
                <p className="mt-1 text-sm text-[rgba(255,247,239,0.66)]">
          ...
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-[0.24em] text-[rgba(255,247,239,0.56)]">
              Explore
            </h4>
          ...
          <div>
            ...
            <div className="mt-5 space-y-4 text-white">
              <p className="text-white">support@bookworld.com</p>
              <p className="text-white">+1 (555) 123-4567</p>
              <p className="text-white">123 Book Street, Reading City</p>

              <p className="rounded-[1.4rem] border border-white/20 bg-white/10 px-4 py-4 text-sm leading-6 text-white">
                Need help choosing a title or using audio tools? Reach out and
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-white/10 pt-6 text-sm text-[rgba(253,253,253,0.6)] md:flex-row md:items-center md:justify-between">
          <p className="text-white">
            &copy; {new Date().getFullYear()} Book World. Crafted for thoughtful
            reading.
          </p>
          <p className="text-white">Built to make every page feel inviting.</p>
        </div>
      </div>
    </footer>
  );
